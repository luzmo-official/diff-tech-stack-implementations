...
A simple Luzmo embedded analytics demo — Vue frontend with a Python (FastAPI) backend.
...
4. The frontend renders the Luzmo dashboard using `@luzmo/vue-embed` with the returned credentials.
